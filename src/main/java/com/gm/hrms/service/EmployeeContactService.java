...
public interface EmployeeContactService {
    ...
    EmployeeContact createContact(Employee employee, EmployeeContactRequestDTO dto);
    EmployeeContact updateContact(Employee employee, EmployeeContactRequestDTO dto);
